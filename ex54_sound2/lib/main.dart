        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  child: const Text('노래', style: TextStyle(fontSize: 24)),
                  onPressed: () {
                    manager.player.setAsset('assets/sounds/backgroun1.mp3');
                  },
                ),
                const SizedBox(width: 10,),
                 ElevatedButton(
                  child: const Text('노래', style: TextStyle(fontSize: 24)),
                  onPressed: () {
                    manager.player.setAsset('assets/sounds/backgroun2.mp3');
                  },
                ),
              ],
            ),
