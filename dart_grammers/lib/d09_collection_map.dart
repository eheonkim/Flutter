void main()
{
  ...
  /*
      MaP컬렉션 생성시 key는 문자열로, value는 정수값을 사용하겠다는
      선언. Map은 이와같이 key와 value의 상으로 이루어진다.
  */
  ...
  map2['멀린'] = 35;  // 추가(기존의 key가 없기때문)
  map2['홍길동'] = 21; //수정 (동일한 key는 존재할 수 없을므ㅗ 수정됨)
  print(map2);
  ...
  // 원소를 통해 각 key와 valu를 출력한다. entries(항목)
  print("=====================");
