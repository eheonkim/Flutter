void main()
{
  ...
  // 실패 시 nu11. tryParse에 try ~ on이 들어가 있음. 그래서 예외가 생기면 null
  ...
  // 여기서 int ? 가없는 이유 val1값에 - 1이 들어오므로 null이 들어올수 없음.
  print('val = $val1'); //예외가 발생하므로 -1이 할당됨.

  // var 는 어떤값이라도 들어올수 있다. 즉 null도 들어올 수 있다는 것이므로
  // ? 을 안써도 됨,
