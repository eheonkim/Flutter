...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(  // print로 출력한 결과는 디버그 콘솔에서 확인
      appBar: AppBar(
      ...
      body: Column(
        ...
        children: <Widget>[ 
          ...
          // 크기를 지정하지 않으면 배율 만큼 자동으로 줄어듬, 노란색 크기만큼
          Image.asset(
            'assets/images/300x300b.png',
          ),

          //해당 배율의 이미지라도 크기를 지정하면 지정한 크기가 적용됨
          // image.asset의 크기가 지정된 것인지 내부의 이미지 크기가 지정된 것은 아니다
          Image.asset(
            'assets/images/300x300b.png',
            // fit: BoxFit.fill,
            width: 100, // 액자의 크기를 지정해 주는 것임. 이렇게 지정해서 사용하는 
                        // 것이 좋다.
          ),
