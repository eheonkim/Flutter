...
class _MyHomePageState extends State<MyHomePage> {
    ...
    return Scaffold(
      ...
      body: Center(
          child: Column(
            ...
            child: const Text('Covid19 공공데이터 파싱', style: TextStyle(fontSize: 24)),
            onPressed: (){
              covid19XMLData();
            },    
          ),
  ...
  void covid19XMLData(){   // 코비드 XML 예제 데이터
    String xmlData = '''
<response>
  <header>
...
''';
    ...
    List data2 = data1['iems']['item'];
    print(data2);

    print('===============================');
    // 배열의 크기만큼 반복해서 id와 name 파싱후 출력
